...
Global Const $__notificationHeight = 115
...
Func _Notifications_Create($__title, $__message, $__callFunction = "", $__closeOnClick = True)
	...
	;message label
	GUICtrlCreateLabel($__message, 10, 40, $__notificationWidth - 20, 35, $__notificationTextAlign)
	GUICtrlSetColor(-1, $__notificationColor)
	GUICtrlSetBkColor(-1, $GUI_BKCOLOR_TRANSPARENT)
	...
	If $__notificationBorder = True Then
		GUICtrlCreateLabel("", 10, $__closingButtonTop, $__notificationWidth - 20, 1)
	Else
...
Func _Notifications_GetTopPos($__notificationID = -1)
	...
	For $__i = 1 To $__notificationID
		...
		$__topPos += 10 + $__notificationHeight
